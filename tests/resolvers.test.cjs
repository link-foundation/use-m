...
describe(`${moduleName} resolvers tests`, () => {
  ...
  test(`${moduleName} jsdelivr resolver resolves subpath`, async () => {
    const { jsdelivr } = resolvers;
  ...
  test(`${moduleName} unpkg resolver resolves URL`, async () => {
